 ...
 * 
 */
public class ViewPagerLazy extends ViewGroup {
	...
	/*
	 * 屏蔽预加载功能,DEFAULT_OFFSCREEN_PAGES为左右预加载的页数,默认为1
	 */
	...
	/*
	 * Simple implementation of the {@link
	 * android.support.v4.view.LazyViewPager.OnPageChangeListener} interface
	 * with stub implementations of each method. Extend this if you do not
	 * intend to override every method of {@link
	 * android.support.v4.view.LazyViewPager.OnPageChangeListener}.
	 */
	...
	public ViewPagerLazy(Context context) {
		super(context);
		initViewPager();
	}

	public ViewPagerLazy(Context context, AttributeSet attrs) {
		super(context, attrs);
		initViewPager();
	}
