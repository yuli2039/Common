...
package com.yu.devlibrary.wheel;
...
import com.yu.devlibrary.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[]{0xFFffffff, 0xddffffff, 0xccffffff};
    // 是否需要画顶部和底部阴影
    ...
    /**
     * 选中状态的框框，默认等于wheelForeground
     */
    private Drawable centerDrawable;
    private GradientDrawable topShadow;// 顶部渐变阴影，根据SHADOWS_COLORS得来
    private GradientDrawable bottomShadow;// 底部渐变阴影，根据SHADOWS_COLORS得来
    ...
    private void drawShadows(Canvas canvas) {
        int height = (int) (1.6 * getItemHeight());
...
//        修改，不使用目标drawable，直接画两条线
//        centerDrawable.setBounds(0, center - offset, getWidth(), center + offset);
//        centerDrawable.draw(canvas);
        Paint paint = new Paint();
        paint.setStrokeWidth(5);
        paint.setColor(Color.parseColor("#00ace3"));

        canvas.drawLine(40, center - offset, getWidth() - 40, center - offset, paint);
        canvas.drawLine(40, center + offset, getWidth() - 40, center + offset, paint);
    }
